...
def main(page: ft.Page):
    ...
    search_input = ft.TextField(hint_text="Buscar canción o artista...", expand=True, border_radius=20)
                ...
                card = ft.Card(
                    content=ft.Container(
                        ...
                        content=ft.Column([
                            ...
                            ft.Row([
                                ft.ElevatedButton("MP3", icon=ft.icons.MUSIC_NOTE, on_click=lambda e, i=vid_id, u=url, t=title: start_download(i, u, t, "audio")),
                                ft.ElevatedButton("MP4", icon=ft.icons.VIDEO_FILE, on_click=lambda e, i=vid_id, u=url, t=title: start_download(i, u, t, "video")),
                            ]),
                            prog_bar,
                            stat_text
                        ])
    ...
    search_btn = ft.IconButton(icon=ft.icons.SEARCH, on_click=on_search, icon_color=ft.colors.PINK)
    
    header = ft.Row([
        ft.Icon(ft.icons.LIBRARY_MUSIC, color=ft.colors.PINK, size=30),
